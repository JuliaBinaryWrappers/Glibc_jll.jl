...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Glibc_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("452aa2e7-e185-58db-8ff9-d3c1fa4bc997"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Glibc", artifacts_toml) for e in artifacts["Glibc"]]
...
if best_platform === nothing
    @debug("Unable to load Glibc; unsupported platform $(triplet(platform_key_abi()))")
else
