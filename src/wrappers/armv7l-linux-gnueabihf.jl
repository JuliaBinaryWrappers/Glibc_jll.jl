...
"""
function __init__()
    global artifact_dir = abspath(artifact"Glibc")
    ...
    global libld_path = normpath(joinpath(artifact_dir, libld_splitpath...))
    ...
    global libm_path = normpath(joinpath(artifact_dir, libm_splitpath...))
    ...
    global libpthread_path = normpath(joinpath(artifact_dir, libpthread_splitpath...))
    ...
    global librt_path = normpath(joinpath(artifact_dir, librt_splitpath...))
